              ...
              <div class="col-md-4">
                ...
                <div class="box box-primary">
                  <div class="box-body box-profile">
                    ...
                    <img width="60px" class="user-profile-60-img img-responsive img-circle" src="{{ url('/') }}/design/AdminLTE/dist/img/user4-128x128.jpg" alt="{{ $topEventCreator[0]->name }}">
              ...
              <div class="col-md-4">
                ...
                <div class="box box-primary">
                  <div class="box-body box-profile">
                    ...
                    <img width="60px" class="user-profile-60-img img-responsive img-circle" src="{{ url('/') }}/design/AdminLTE/dist/img/user4-128x128.jpg" alt="{{ $topChallengeCreator[0]->name }}">
              ...
              <div class="col-md-4">
                ...
                <div class="box box-primary">
                  <div class="box-body box-profile">
                    ...
                    <img width="60px" class="user-profile-60-img img-responsive img-circle" src="{{ url('/') }}/design/AdminLTE/dist/img/user4-128x128.jpg" alt="{{ $topappliedEvents[0]->name }}">
               ...
               <div class="col-md-4">
                ...
                <div class="box box-primary">
                  <div class="box-body box-profile">
                    ...
                    <img width="60px" class="user-profile-60-img img-responsive img-circle" src="{{ url('/') }}/design/AdminLTE/dist/img/user4-128x128.jpg" alt="{{ $topchallenged[0]->name }}">
              ...
              <div class="col-md-4">
                ...
                <div class="box box-primary">
                  <div class="box-body box-profile">
                    ...
                    <img width="60px" class="user-profile-60-img img-responsive img-circle" src="{{ url('/') }}/design/AdminLTE/dist/img/user4-128x128.jpg" alt="{{ $topcandidatedEvents[0]->name }}">
              ...
              <div class="col-md-4">
                ...
                <div class="box box-primary">
                  <div class="box-body box-profile">
                    ...
                    <img width="60px" class="user-profile-60-img img-responsive img-circle" src="{{ url('/') }}/design/AdminLTE/dist/img/user4-128x128.jpg" alt="{{ $topPlayerReservations[0]->name }}">
               ...
               <div class="col-md-4">
                ...
                <div class="box box-success">
                  <div class="box-body box-profile">
                    ...
                    <img width="60px" class="user-profile-60-img img-responsive img-circle" src="{{ url('/') }}/design/AdminLTE/dist/img/user4-128x128.jpg" alt="{{ $topclubBranches[0]->name }}">
