...
Route::group([ 'middleware' => ['auth'] ], function(){
	...
	// Load add branch record for the club account in register procces
	Route::get('club/registerAddBranch', 'ClubProfilesController@registerAddBranch');

	// Load Editable branch record for the club account in register procces
	Route::get('club/{clubBranch}/DisplayEditBranchRegister', 'ClubBranchesController@DisplayEditBranchRegister');

	// Load add playground record to {{{clubBranch}}} for the club account in register procces
	Route::get('club/{clubBranch}/DisplayAddPlaygroundRegister', 'PlaygroundsController@DisplayAddPlaygroundRegister');
...
//&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&//	
	...
	Route::post('/registerClub', 'ClubProfilesController@registerClub');
...
//&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&//
	Route::group([ 'middleware' => ['isActive', 'isClub', 'web'] ], function(){ // login as admin for this links
...
Route::get('logout', 'ClubProfilesController@logout');
